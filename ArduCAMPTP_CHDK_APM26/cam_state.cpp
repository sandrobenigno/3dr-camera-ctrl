...
CamState::CamState(){
  ...
  session = 0; //< 0: stop, 1: start or keep it up //Session control e.g. show/hide lens
  zoom_pos = 0; //< 1 to N //Zoom's absolute position (0 means ignore)
  focus_lock = 0; //< 0: unlock focus and keep unlocked, 1: lock focus or reset the focus and keep locked
